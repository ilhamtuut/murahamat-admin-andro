...
import wad.wan.murahamatdistro.Search;
 ...
 */
public class SearchAdapte extends RecyclerView.Adapter<SearchAdapte.MyViewHolder>{
    ...
    public SearchAdapte(Context mContext, List<Products> albumList) {
